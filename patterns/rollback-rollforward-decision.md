...
title: Rollback Roll Forward Decision
type: decision-guide
status: draft
...
applies_when:
  - The user asks about rollback roll forward decision in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 19 and 21."
...
Decide whether to restore a previous version or move forward with a fix based on state, compatibility, and recovery speed.
...
Use rollback roll forward decision as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 19 and 21. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
