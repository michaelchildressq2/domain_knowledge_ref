...
aliases:
  ...
  - disposable infrastructure
applies_when:
  - The user asks about disposable infrastructure in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 2, 11, 13, and 21."
...
Design replaceable infrastructure so failed or outdated parts can be rebuilt instead of nursed back to health.
...
Use disposable infrastructure as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 2, 11, 13, and 21. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
