...
aliases:
  ...
  - small safe changes
applies_when:
  - The user asks about small safe changes in an Infrastructure as Code or platform engineering context.
...
Use incremental, iterative, and walking-skeleton approaches to evolve infrastructure without betting on one large cutover.
...
Use small safe changes as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
