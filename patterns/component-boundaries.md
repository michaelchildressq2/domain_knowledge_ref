...
aliases:
  ...
  - component boundaries
applies_when:
  - The user asks about component boundaries in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 15 and 16."
...
Split infrastructure into components with low coupling, high cohesion, and clear responsibility for change.
...
Use component boundaries as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 15 and 16. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
