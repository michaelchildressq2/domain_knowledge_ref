...
aliases:
  ...
  - reproducible infrastructure
applies_when:
  - The user asks about reproducible infrastructure in an Infrastructure as Code or platform engineering context.
...
Ensure infrastructure and runtime parts can be rebuilt from known inputs without manual decisions.
...
Use reproducible infrastructure as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
