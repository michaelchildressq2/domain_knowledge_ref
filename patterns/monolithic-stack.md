...
aliases:
  ...
  - monolithic stack
applies_when:
  - The user asks about monolithic stack in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 5, 14, 15, and 21."
...
A monolithic stack manages too many unrelated resources, making changes slow, risky, and hard to test independently.
...
Use monolithic stack as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 5, 14, 15, and 21. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
