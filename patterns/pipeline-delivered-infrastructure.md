...
title: Pipeline Delivered Infrastructure
...
aliases:
  ...
  - pipeline delivered infrastructure
applies_when:
  - The user asks about pipeline delivered infrastructure in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 8 and 19."
...
Deliver infrastructure code through pipelines that build, test, promote, apply, and record evidence for every change.
...
Use pipeline delivered infrastructure as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 8 and 19. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
