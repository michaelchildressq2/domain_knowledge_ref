...
aliases:
  ...
  - cluster per environment
applies_when:
  - The user asks about cluster per environment in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapter 14."
...
Use separate clusters when environment isolation, failure containment, or change independence outweighs shared-cluster efficiency.
...
Use cluster per environment as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapter 14. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
