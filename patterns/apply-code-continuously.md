...
aliases:
  ...
  - apply code continuously
applies_when:
  - The user asks about apply code continuously in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 4, 12, and 19."
...
Reapply infrastructure code regularly or on change to keep managed systems aligned with declared intent.
...
Use apply code continuously as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 4, 12, and 19. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
