...
aliases:
  ...
  - simple stack parameters
applies_when:
  - The user asks about simple stack parameters in an Infrastructure as Code or platform engineering context.
...
Keep stack parameters simple, explicit, and limited to values that should vary across instances.
...
Use simple stack parameters as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
