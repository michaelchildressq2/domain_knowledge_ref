...
title: Risk Based Infrastructure Testing
...
aliases:
  ...
  - risk based infrastructure testing
applies_when:
  - The user asks about risk based infrastructure testing in an Infrastructure as Code or platform engineering context.
...
Choose infrastructure tests based on the specific change risks they reduce, not on a desire to test every declaration.
...
Use risk based infrastructure testing as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
