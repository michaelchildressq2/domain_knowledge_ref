...
aliases:
  ...
  - stack data lookup
applies_when:
  - The user asks about stack data lookup in an Infrastructure as Code or platform engineering context.
...
Let consumer stacks read provider outputs through the stack tool when stacks need explicit infrastructure dependencies.
...
Use stack data lookup as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
