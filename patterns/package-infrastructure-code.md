...
title: Package Infrastructure Code
...
aliases:
  ...
  - package infrastructure code
applies_when:
  - The user asks about package infrastructure code in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapter 19."
...
Package or otherwise pin infrastructure code versions so pipelines apply the intended artifact consistently across environments.
...
Use package infrastructure code as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapter 19. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
