...
aliases:
  ...
  - resource matching
applies_when:
  - The user asks about resource matching in an Infrastructure as Code or platform engineering context.
...
Discover dependency resources by matching supported names or tags when loose coupling is more useful than direct stack outputs.
...
Use resource matching as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
