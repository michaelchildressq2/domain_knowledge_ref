...
title: Production Change Monitoring
...
aliases:
  ...
  - production change monitoring
applies_when:
  - The user asks about production change monitoring in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 8, 20, and 21."
...
Use monitoring as part of the testing strategy for risks that only appear during or after live infrastructure change.
...
Use production change monitoring as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 8, 20, and 21. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
