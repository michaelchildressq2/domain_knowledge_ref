...
aliases:
  ...
  - externalized configuration
applies_when:
  - The user asks about externalized configuration in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 4, 6, and 7."
...
Separate reusable code from environment-specific values so the same code can safely create multiple stack instances.
...
Use externalized configuration as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 4, 6, and 7. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
