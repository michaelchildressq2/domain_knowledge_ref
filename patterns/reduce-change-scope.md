...
aliases:
  ...
  - reduce change scope
applies_when:
  - The user asks about reduce change scope in an Infrastructure as Code or platform engineering context.
...
sources:
  - "book: Kief Morris, Infrastructure as Code, second edition, iac2.pdf; Chapters 15 and 21."
...
Make infrastructure changes smaller by splitting systems, sequencing work, and limiting each change to one coherent intent.
...
Use reduce change scope as a deliberate design choice. Make the boundary, ownership, inputs, outputs, and failure behavior visible in code and delivery workflow. Prefer small, testable, reviewable changes over broad implicit behavior.
...
Synthesized from Chapters 15 and 21. Source confidence is high because the chapter text was extracted locally from the user-provided PDF. No source excerpts are stored here.
